...
check('PWA', 'manifest and versioned Service Worker are present', fs.existsSync(path.join(ROOT, 'manifest.webmanifest')) && serviceWorker.includes('math-bauman-webapp-v2-l4'), null);
